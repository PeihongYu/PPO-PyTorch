...
from algos.PPO_continuous_v3 import *
from envs.drone_env_human_follow_v4 import *
...
if args.save_traj:
    ...
    if args.log_comet:
       experiment.add_tags([folder_name, 'obstacles with depth img input', 'slow speed']) 
