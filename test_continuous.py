...
# trajectory logging
parser.add_argument('--test_mode', type=bool, default=True)  # Disable all the logging if in test mode
...
parser.add_argument('--user_name', type=str, default="vishnu")
...
if args.log_comet:
    if args.user_name == 'peihong':
        experiment = Experiment(api_key="CC3qOVi4obAD5yimHHXIZ24HA", project_name="human-following-test",
                                workspace="peihongyu")
    elif args.user_name == 'vishnu':
        experiment = Experiment(api_key="NaB7y40lAj6qp3SyYRONzLiuJ", project_name="human-following-test",
                                workspace="vishnuds")
...
if args.save_traj:
    ...
    folder_name = str(int(time.time()))+"_test_1700"
...
def test():
    ...
    filename = "/PPO_continuous_drone_env_human_follow_v1_1700.pth"
